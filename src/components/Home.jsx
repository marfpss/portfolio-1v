  ...
  return (
    <Container id="container" className="container">
      <Card id="card" className="d-flex flex-column align-items-center justify-content-center text-center">
        <div className="avatar"> <img src="https://cdn.discordapp.com/attachments/901945232529162250/1106412807609667674/6db2e35013a4252696a9bb7c7804a701.jpg" alt="Avatar" /></div>
        <h1 id="name">
          Marcelo
        </h1>
        <h2 id="surname">
          Mais conhecido como MarFpss
        </h2>
        <h3 id="about">
          Sobre mim
        </h3>
        ...
        <div id="icon" className="d-flex justify-content-center">
          <a id="icon" target="_blank" href="https://www.instagram.com/marcelokkk_019/" className="icon-link">
            <FaInstagram className="icon" />
          </a>
          <a id="icon" target="_blank" href="https://github.com/marfpss" className="icon-link">
